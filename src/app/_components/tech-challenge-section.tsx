            ...
            <div className='bg-white/10 backdrop-blur-xl rounded-2xl p-8 border border-white/20 group hover:border-[#541d36]/50 transition-all duration-300'>
              ...
              <div className='grid grid-cols-3 gap-4 mb-6'>
                <div className='text-center group-hover:scale-105 transition-transform duration-300'>
                  ...
                  <div className='font-round-gothic text-2xl font-bold text-[#541d36]'>Oct 4th</div>
            ...
            <div className='relative w-96 h-96 mx-auto group'>
              ...
              <div className='absolute inset-0 flex items-center justify-center'>
                <div className='text-center text-white'>
                  ...
                  <div className='text-xs bg-[#541d36]/20 px-3 py-1 rounded-full border border-[#541d36]/30 group-hover:bg-[#541d36]/30 transition-colors'>Open to All
                  </div>
                </div>
              </div>
